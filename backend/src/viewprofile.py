...
class ViewUser(Resource):
	...
	user_parser.add_argument('username', location='args', default='username')
	...
	def get(self):
		...
		return {'firstname' : UserRes.fname, 'lastname' : UserRes.lname, 'email': UserRes.email, 'phone' : UserRes.phone, 'picture' : UserRes.picture, 'Number of Transactions' : UserRes.num_transactions, 'Rating': UserRes.rating}
