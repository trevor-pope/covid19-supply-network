...
CREATE TABLE `requests` (
  ...
  KEY `fk_email_idx` (`userEmail`),
  CONSTRAINT `fk_email` FOREIGN KEY (`userEmail`) REFERENCES `user` (`email`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-05-08 16:28:58
